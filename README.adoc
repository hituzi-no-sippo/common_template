...
:revnumber: v0.33.0
:revdate: 2022-06-11T08:32:43+0900
:revremark: Add git pre-commit hook for check broken symlinks
:description: README
...
:check_symlinks_link: link:{pre_commit_repository_url}#check-symlinks[check symlinks^]
* {check_symlinks_link}
