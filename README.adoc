...
:revnumber: v0.40.0
:revdate: 2022-06-27T18:05:27+0900
:revremark: Add git hooks for TOML format
:description: README
...
:pre_commit_for_toml_format_and_lint_link: link:{github_url}/{owner_name}/pre-commit-toml-with-taplo[{owner_name}/pre-commit-toml-with-taplo^]
.Git Hooks
pre-commit::
format:::
